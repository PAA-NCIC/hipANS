...
TORCH_LIBRARY(hipans, m) {
  m.impl(
      TORCH_SELECTIVE_NAME("hipans::max_float_compressed_output_size"),
      TORCH_FN(hipans::max_float_compressed_output_size));
  m.impl(
      TORCH_SELECTIVE_NAME("hipans::max_float_compressed_size"),
      TORCH_FN(hipans::max_float_compressed_size));
  m.impl(
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("hipans::compress_data_split_size"),
      TORCH_FN(hipans::compress_data_split_size));
  m.impl(
      TORCH_SELECTIVE_NAME("hipans::compress_data_simple"),
      TORCH_FN(hipans::compress_data_simple));

  m.impl(
      TORCH_SELECTIVE_NAME("hipans::decompress_data"),
      TORCH_FN(hipans::decompress_data));
  m.impl(
      TORCH_SELECTIVE_NAME("hipans::decompress_data_split_size"),
      TORCH_FN(hipans::decompress_data_split_size));
  m.impl(
      TORCH_SELECTIVE_NAME("hipans::decompress_data_simple"),
      TORCH_FN(hipans::decompress_data_simple));
}
